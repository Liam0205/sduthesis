...
- If the task is about `\sdusetup`, `l3build`, release tagging, changelog maintenance, regression coverage, CI, issue templates, documentation-driver choices, or repository-level modernization facts, read `llmdoc/reference/modernization-reference.md`.
...
- Release, changelog, or packaging issue: start with project essentials, then modernization reference.
